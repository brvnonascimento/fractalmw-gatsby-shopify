...
export default () => {
  ...
  return (
    <Box d={'flex'} flexDirection={'column'} gridRowGap={2}>
      ...
      <Box as="main" d={'flex'} flexDirection={'column'} alignItems={'center'}>
        <BoxContainer
          d={'flex'}
        ...
        >
          ...
          >
            ...
            <Text fontWeight={'medium'}>
              ...
              Dolore adipisicing proident in dolor sint laboris anim occaecat
              do. Ipsum aliquip nulla occaecat eiusmod in cupidatat in id velit
              occaecat eiusmod nisi. Laborum minim elit sint veniam laborum
              laborum tempor reprehenderit duis. Tempor ipsum magna consectetur
              in irure tempor. Nostrud aliquip occaecat cupidatat est commodo
